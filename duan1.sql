...
(96, 'BK2025000096', 20, 8, 99, '2025-12-07', '2025-12-10', 1, 22222222.00, 10000000.00, 'Đã xác nhận', 'Đã cọc', NULL, 'Cơ cấu: 1 Lớn, 0 Trẻ em', NULL);
...
(70, 96, 100, 'Người lớn', '666666666', NULL, 'qqqqq'),
(71, 96, 101, 'Người lớn', '6333333333', NULL, 'qqqqqqqq');
...
(1, 8, 'Người lớn', 1111.00, '2025-12-07', '2026-12-07'),
(2, 8, 'Trẻ em', 11.00, '2025-12-07', '2026-12-07');
...
(99, 'hieu', NULL, '555555555555', '', '', NULL, '2025-12-07 14:50:15'),
(100, 'ffffffffff', NULL, '6666666666', NULL, NULL, '666666666', '2025-12-07 14:50:15'),
(101, 'eeeeeeeee', NULL, '444444444444', NULL, NULL, '6333333333', '2025-12-07 14:50:15');
...
(22, 8, 'LKH1765093496', '2025-12-20', '2025-12-23', '05:30:00', 'Nhà Hát Lớn', 24, 'Nhận khách', 0, 11111111.00, 111111.00);
...
(4, 'cáp treo', 'Khác', 'aaaaaaaaaaaaaa', '12312312423', 'Hoạt động');
...
(82, 22, 1, 'Hướng dẫn viên'),
(83, 22, 2, 'Hướng dẫn viên');
...
(8, 1, 'AAAA', NULL, 'AA', 'A', 4, 'Hoạt động', '2025-12-07 14:30:32');
...
--
ALTER TABLE `booking`
  MODIFY `MaBooking` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
...
--
ALTER TABLE `chitietkhachbooking`
  MODIFY `MaChiTiet` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `giatour`
  MODIFY `MaGia` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `khachhang`
  MODIFY `MaKhachHang` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT for table `lichkhoihanh`
--
ALTER TABLE `lichkhoihanh`
  MODIFY `MaLichKhoiHanh` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `lichtrinhtour`
--
ALTER TABLE `lichtrinhtour`
  MODIFY `MaLichTrinh` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `phanbonhansu`
  MODIFY `MaPhanBo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;

--
-- AUTO_INCREMENT for table `phan_bo_tai_nguyen`
--
ALTER TABLE `phan_bo_tai_nguyen`
  MODIFY `MaPhanBo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tour`
  MODIFY `MaTour` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
