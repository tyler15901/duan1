<style>
    ...
    .timeline-item { position: relative; padding-bottom: 30px; border-left: 2px solid #e9ecef; padding-left: 25px; }
    .timeline-item:last-child { border-left: 0; }
    .timeline-marker { 
        position: absolute; left: -11px; top: 0; width: 20px; height: 20px; 
        background: #fff; border: 4px solid #0d6efd; border-radius: 50%; 
    }
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h6 class="fw-bold text-primary mb-1">Ngày <?php echo $day['NgayThu']; ?>: <?php echo $day['TieuDe']; ?></h6>
            ...
            <div class="card-body">
                <div class="row g-2">
                    <?php if(!empty($gallery)): ?>
                        ...
                        <div class="col-6">
                            <img src="<?php echo BASE_URL . '/' . $img['DuongDan']; ?>" class="img-fluid rounded border w-100" style="height: 100px; object-fit: cover;">
                        </div>
                        <?php endforeach; ?>
                    <?php else: ?>
