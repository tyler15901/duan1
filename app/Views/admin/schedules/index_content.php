            ...
            <div class="col-md-5">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control border-start-0 bg-light"
                        placeholder="Tìm theo Mã lịch, Tên tour...">
                </div>
            </div>
            <div class="col-md-3">
                    ...
                    <?php if (empty($schedules)): ?>
                        <tr>
                            <td colspan="7" class="text-center py-5 text-muted">
                                <img src="https://cdn-icons-png.flaticon.com/512/7486/7486747.png" width="64"
                                    class="mb-3 opacity-50">
                                <p>Chưa có lịch khởi hành nào.</p>
                                <a href="<?php echo BASE_URL; ?>/schedule/create" class="btn btn-sm btn-outline-primary">Tạo
                                    ngay</a>
                            </td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($schedules as $item): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small class="text-muted"><i class="bi bi-clock"></i> <?php echo $item['SoNgay']; ?>
                                        ngày</small>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="text-center border rounded px-2 py-1 bg-light me-2">
                                            <div class="small fw-bold text-uppercase text-danger">
                                                <?php echo date('M', strtotime($item['NgayKhoiHanh'])); ?></div>
                                            <div class="h5 mb-0 fw-bold">
                                                <?php echo date('d', strtotime($item['NgayKhoiHanh'])); ?></div>
                                        </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <div class="fw-bold"><?php echo date('H:i', strtotime($item['GioTapTrung'])); ?>
                                            </div>
                                            <div class="small text-muted text-truncate" style="max-width: 150px;">
                                                <?php echo $item['DiaDiemTapTrung']; ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <span
                                        class="badge bg-info text-dark bg-opacity-10 border border-info px-3 py-2 rounded-pill">
                                        <?php echo $item['SoKhachHienTai']; ?> / <?php echo $item['SoChoToiDa'] ?? '??'; ?>
                                    </span>
                                </td>
                                <td>
                                    <?php
                                    $statusClass = 'light text-dark border'; // Mặc định
                                    if ($item['TrangThai'] == 'Nhận khách')
                                        $statusClass = 'success';
                                    elseif ($item['TrangThai'] == 'Đã đóng')
                                        $statusClass = 'secondary';
                                    elseif ($item['TrangThai'] == 'Đang chạy')
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                                            <li><a class="dropdown-item"
                                                    href="<?php echo BASE_URL; ?>/schedule/show/<?php echo $item['MaLichKhoiHanh']; ?>"><i
                                                        class="bi bi-eye text-info me-2"></i> Chi tiết</a></li>
                                            <li><a class="dropdown-item"
                                                    href="<?php echo BASE_URL; ?>/schedule/guests/<?php echo $item['MaLichKhoiHanh']; ?>"><i
                                                        class="bi bi-people text-primary me-2"></i> Danh sách khách</a></li>
                                            <li><a class="dropdown-item"
                                                    href="<?php echo BASE_URL; ?>/schedule/expenses/<?php echo $item['MaLichKhoiHanh']; ?>"><i
                                                        class="bi bi-cash-coin text-success me-2"></i> Thu chi & Lãi</a></li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="<?php echo BASE_URL; ?>/schedule/edit/<?php echo $item['MaLichKhoiHanh']; ?>"><i
                                                        class="bi bi-pencil text-warning me-2"></i> Sửa lịch</a></li>
                                            <li><a class="dropdown-item text-danger"
                                                    href="<?php echo BASE_URL; ?>/schedule/delete/<?php echo $item['MaLichKhoiHanh']; ?>"
