...
<div class="row g-4 mb-4">
    <div class="col-md-4">
        <div class="card shadow-sm border-0 bg-success bg-opacity-10 h-100">
            <div class="card-body">
                <div class="text-success text-uppercase small fw-bold mb-1">Tổng Doanh thu</div>
...
<div class="row g-4">
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small class="text-muted"><i class="bi bi-calendar"></i> <?php echo date('d/m/Y', strtotime($row['NgayKhoiHanh'])); ?></small>
                                </td>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-<?php echo $marginClass; ?> bg-opacity-25 border border-<?php echo $marginClass; ?> text-<?php echo str_replace(' text-dark','',$marginClass); ?>">
                                        <?php echo $margin; ?>%
                                    </span>
                                </td>
                            </tr>
    ...
    <div class="col-lg-12 d-print-none">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3">
                <h6 class="m-0 fw-bold text-dark"><i class="bi bi-bar-chart-line"></i> Biểu đồ lợi nhuận năm <?php echo $current_year; ?></h6>
            </div>
            <div class="card-body">
