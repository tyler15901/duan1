                            ...
                            <?php if (!empty($data['schedules'])): ?>
                                <?php foreach ($data['schedules'] as $sch): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <i class="far fa-clock"></i> <?= date('H:i', strtotime($sch['GioTapTrung'])) ?><br>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <button class="btn btn-sm btn-secondary" disabled title="Đã có khách đặt"><i class="fas fa-lock"></i></button>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
